...
if (fs.existsSync(path.resolve(themePath, '.babelrc'))) {
  // Fallback for theme with babel 6.
  logger.log('Installing legacy dependency babel-loader@7.1.4');
  childProcess.spawnSync('npm', ['install', 'babel-loader@7.1.4', '--no-save'], { cwd: path.resolve(__dirname, '..') });
  logger.log('Using legacy babel-loader@7.1.4');
  ...
  logger.log('Installing specified dependency babel-loader');
  childProcess.spawnSync('npm', ['install', `babel-loader@${pckg.dependencies['babel-loader']}`, '--no-save'], { cwd: path.resolve(__dirname, '..') });
  logger.log('Using specified babel-loader');
