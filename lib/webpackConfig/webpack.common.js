...
var widgetConfig = (0, _getComponentsSettings2.default)().widgets;
var widgetEntries = {};

Object.keys(widgetConfig).forEach(function (widget) {
...
var stringReplacementLoader = _stringReplaceWebpackPlugin2.default.replace({
  replacements: [{
    ...
    replacement: function replacement() {
      return JSON.stringify((0, _path.resolve)(THEME_PATH, '..', '..', 'extensions'));
    }
  }]
});
...
exports.default = {
  ...
  resolve: {
    ...
    modules: [(0, _path.resolve)(THEME_PATH, NODE_MODULES), (0, _path.resolve)(THEME_PATH, 'widgets'), (0, _path.resolve)(THEME_PATH, '..', '..', 'extensions')].concat(_toConsumableArray((0, _getExtensionsNodeModulesPaths2.default)()), [(0, _path.resolve)(SDK_NODE_MODULES), (0, _path.resolve)(LOCAL_NODE_MODULES)])
  },
  performance: {
    hints: false
  },
