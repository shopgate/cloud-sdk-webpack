...
exports.default = {
  ...
  entry: {
    common: [(0, _path.resolve)(_variables.NODE_MODULES, 'babel-polyfill'), (0, _path.resolve)(_variables.NODE_MODULES, 'intl'), (0, _path.resolve)(_variables.NODE_MODULES, 'intl/locale-data/jsonp/' + (0, _convertLanguageToISO2.default)(language) + '.js'), 'react', 'react-dom', 'lodash', 'gsap', 'swiper', (0, _path.resolve)(__dirname, './helpers/polyfill')]
  },
  externals: {
    cheerio: 'window',
  ...
  resolve: {
    ...
    modules: [(0, _path.resolve)(_Themes2.default.getPath(), 'node_modules'), (0, _path.resolve)(_Themes2.default.getPath(), 'widgets'), (0, _path.resolve)(_variables.EXTENSIONS_PATH)].concat(_toConsumableArray((0, _getExtensionsNodeModulesPaths2.default)()), [(0, _path.resolve)(_variables.NODE_MODULES)])
  },
  performance: {
    hints: false
  },
