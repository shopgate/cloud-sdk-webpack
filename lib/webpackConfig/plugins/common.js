...
var plugins = [new _webpack2.default.DefinePlugin({
  ...
  minChunks: function minChunks(module, count) {
    return module.resource && module.resource.indexOf('lodash') !== -1 || module.resource && module.resource.indexOf('gsap') !== -1 || module.resource && module.resource.indexOf('hammerjs') !== -1 || module.resource && module.resource.indexOf('swiper') !== -1 || count >= 2;
  },
  name: 'common',
